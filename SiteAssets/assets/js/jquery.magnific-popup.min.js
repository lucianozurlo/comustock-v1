  ...
  (t.prototype = {
    ...
    open: function (c) {
      ...
      (b.types = []), (f = ''), c.mainEl && c.mainEl.length
        ...
        : (b.ev = d), c.key
        ? (b.popupsCache[c.key] ||
            (b.popupsCache[c.key] = {}), (b.currTemplate =
            b.popupsCache[c.key]))
    ...
    close: function () {
      b.isOpen &&
        (y (i), (b.isOpen = !1), b.st.removalDelay &&
          !b.isLowIE &&
    ...
    _close: function () {
      ...
      var c = r + ' ' + q + ' ';
      if (
        (b.bgOverlay.detach (), b.wrap.detach (), b.container.empty (), b.st
          .mainClass && (c += b.st.mainClass + ' '), b._removeClassFromMFP (
          c
        ), b.fixedContentPos)
      ) {
        var e = {marginRight: ''};
    ...
    updateItemHTML: function () {
      ...
      b.contentContainer.detach (), b.content &&
        b.content.detach (), c.parsed || (c = b.parseEl (b.index));
      var d = c.type;
      if (
        (y ('BeforeChange', [
    ...
    if ('string' == typeof c)
      if ('open' === c) {
        ...
        f.items
          ? (e = f.items[g])
          : ((e = d), f.delegate && (e = e.find (f.delegate)), (e = e.eq (
              g
        ...
        var d = a.extend (
          {
            ...
            success: function (d, e, f) {
              ...
              y ('ParseAjax', g), b.appendContent (
                a (g.data),
                I
              ), (c.finished = !0), J (), b._setFocus (), setTimeout (
                function () {
                  b.wrap.addClass (q);
                },
                16
  ...
  a.magnificPopup.registerModule ('image', {
    ...
    proto: {
      ...
      _onImageHasSize: function (a) {
        a.img &&
          ((a.hasSize = !0), L &&
            clearInterval (L), (a.isCheckingImgSize = !1), y (
            'ImageHasSize',
            a
          ), a.imgHidden &&
            (b.content &&
              b.content.removeClass ('mfp-loading'), (a.imgHidden = !1)));
      },
      ...
      getImage: function (c, d) {
        ...
        return b._parseMarkup (
          ...
          ? (L && clearInterval (L), c.loadError
              ? (d.addClass ('mfp-loading'), b.updateStatus (
                  'error',
                  h.tError.replace ('%url%', c.src)
                ))
          ...
          return e.indexOf (this.index) > -1
            ? (this.id &&
                (e = 'string' == typeof this.id
                  ...
                  : this.id.call (this, e)), (e = this.src.replace (
                '%id%',
                e
              )), !1)
            : void 0;
