...
!(function (t, e) {
  ...
  return (e.on = function (t, e) {
    ...
    if (i && i.length) {
      ...
      for (var s = this._onceEvents && this._onceEvents[t]; n; ) {
        var r = s && s[n];
        r && (this.off (t, n), delete s[n]), n.apply (this, e), (o += r
          ? 0
          : 1), (n = i[o]);
      }
      return this;
  ...
  function s (e) {
    if (
      (n (), 'string' == typeof e && (e = document.querySelector (e)), e &&
        'object' == typeof e &&
        e.nodeType)
    ) {
      var s = o (e);
      ...
      var S = t (s.height);
      return S !== !1 && (a.height = S + (z ? 0 : y + I)), (a.innerWidth =
        a.width - (p + _)), (a.innerHeight =
        a.height - (y + I)), (a.outerWidth = a.width + g), (a.outerHeight =
        a.height + v), a;
    }
  }
  var r,
  ...
  function o (t, e) {
    t &&
      ((this.element = t), (this.layout = e), (this.position = {
        x: 0,
        y: 0,
      }), this._create ());
  }
  ...
  var s = document.documentElement.style,
    ...
    u = {WebkitTransition: 'webkitTransitionEnd', transition: 'transitionend'}[
      r
    ],
    h = {
      transform: a,
  ...
  (d.constructor = o), (d._create = function () {
    ...
    var t = getComputedStyle (this.element),
      ...
      a = n.indexOf ('%') != -1
        ...
        : parseInt (n, 10);
    (r = isNaN (r) ? 0 : r), (a = isNaN (a) ? 0 : a), (r -= e
      ? s.paddingLeft
      : s.paddingRight), (a -= i
      ? s.paddingTop
      : s.paddingBottom), (this.position.x = r), (this.position.y = a);
  ...
  (d.ontransitionend = function (t) {
    if (t.target === this.element) {
      ...
      if (
        (delete e.ingProperties[o], i (e.ingProperties) &&
          this.disableTransition (), o in e.clean &&
          ((this.element.style[t.propertyName] = ''), delete e.clean[o]), o in
          e.onEnd)
      ) {
        var n = e.onEnd[o];
  ...
  o.extend (c, e.prototype), (c.option = function (t) {
    ...
    n
      ? ('string' == typeof n
          ...
          : n instanceof HTMLElement && (o = n), (this[t] = o ? i (o)[e] : n))
      : (this[t] = 0);
    ...
    if (t) {
      ...
      e &&
        (this._setContainerMeasure (e.width, !0), this._setContainerMeasure (
          e.height,
          !1
        ));
    }
  ...
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof module && module.exports
        ...
        : ((t.Isotope = t.Isotope || {}), (t.Isotope.LayoutMode = e (
            t.getSize,
            t.Outlayer
          )));
}) (window, function (t, e) {
