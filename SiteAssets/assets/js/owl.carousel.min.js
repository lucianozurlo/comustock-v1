...
!(function (a, b, c, d) {
  ...
  (e.Defaults = {
    ...
    },
    {
      ...
      run: function (a) {
        ...
        if (c && a.items.merge)
          for (; b--; )
            (a.css.width = this._widths[this.relative (b)]), d
              .eq (b)
              .css (a.css);
    ...
    this.$element.addClass (this.options.loadingClass), (this.$stage = a (
      ...
      ), this.registerEventHandlers (), this.leave (
      'initializing'
    ...
    c
      ? (a.each (c, function (a) {
          a <= b && a > d && (d = Number (a));
        }), (e = a.extend ({}, this.options, c[d])), 'function' ==
          typeof e.stagePadding &&
    ...
    return (
      ...
      (this._width !== this.$element.width () &&
        (!!this.$element.is (':visible') &&
          (this.enter ('resizing'), this.trigger (
            'resize'
          ).isDefaultPrevented ()
    ...
    3 !== b.which &&
      (a.support.transform
        ...
        0
      ), (this._drag.time = new Date ().getTime ()), (this._drag.target = a (
        b.target
      )), (this._drag.stage.start = d), (this._drag.stage.current = d), (this._drag.pointer = this.pointer (
        b
      )), a (c).on (
    ...
    this.is ('dragging') &&
      (a.preventDefault (), this.settings.loop
        ? ((b = this.coordinates (this.minimum ())), (c =
            this.coordinates (this.maximum () + 1) - b), (f.x =
            ((f.x - b) % c + c) % c + b))
        : ((b = this.settings.rtl
    ...
    a (c).off ('.owl.core'), this.$element.removeClass (
      ...
      (this.speed (
        ...
        'position'
      ), this.update (), (this._drag.direction = f), (Math.abs (d.x) > 3 ||
    ...
    return b === d
      ...
      : (this.settings.center
          ? (this.settings.rtl && ((e = -1), (f = b + 1)), (c = this
              ._coordinates[b]), (c +=
    ...
    (c = c === d
      ? this._items.length
      : this.normalize (c, !0)), (b = b instanceof jQuery
      ? b
      : a (b)), this.trigger ('add', {
      content: b,
      position: c,
    }), (b = this.prepare (b)), 0 === this._items.length ||
      c === this._items.length
      ? (0 === this._items.length && this.$stage.append (b), 0 !==
          this._items.length && this._items[c - 1].after (b), this._items.push (
          b
        ), this._mergers.push (
          1 *
            b
      ...
      : (this._items[c].before (b), this._items.splice (
          c,
          0,
          b
    ...
    (a = this.normalize (a, !0)), a !== d &&
      (this.trigger ('remove', {
        ...
        position: a,
      }), this._items[a].remove (), this._items.splice (
        a,
        1
      ), this._mergers.splice (a, 1), this.invalidate (
        'items'
    ...
    this.$element.off ('.owl.core'), this.$stage.off ('.owl.core'), a (c).off (
      ...
      (b.clearTimeout (this.resizeTimer), this.off (
        b,
        'resize',
    ...
    return this._supress[b] ||
      ...
      }), this.register ({type: e.Type.Event, name: b}), this.$element.trigger (
        j
      ), this.settings &&
    ...
    if (b.type === e.Type.Event) {
      if (
        (a.event.special[b.name] || (a.event.special[b.name] = {}), !a.event
          .special[b.name].owl)
      ) {
      ...
      b.type === e.Type.State &&
        (this._states.tags[b.name]
          ...
          : (this._states.tags[b.name] = b.tags), (this._states.tags[
          b.name
        ] = a.grep (
          this._states.tags[b.name],
    ...
    return this.each (function () {
      ...
      f ||
        ((f = new e (this, 'object' == typeof b && b)), d.data (
          'owl.carousel',
          f
        ), a.each (
          [
  ...
  (e.Defaults = {
    ...
    this._interval ||
      ((this._visible = this._core.$element.is (
        ':visible'
  ...
  (e.Defaults = {
    ...
    if (
      (b.wrap ('<div class="owl-video-wrapper"' + g + '></div>'), this._core
        .settings.lazyLoad && ((i = 'data-src'), (j = 'owl-lazy')), h.length)
    )
    ...
    this._playing ||
      (this._core.enter ('playing'), this._core.trigger (
        'play',
        null,
        'video'
      ), (e = this._core.items (
        this._core.relative (e.index ())
      )), this._core.reset (e.index ()), 'youtube' === f.type
        ? (c =
            '<iframe width="' +
            g +
            '" height="' +
  ...
  var e = function (b) {
    (this.core = b), (this.core.options = a.extend (
      ...
      'change.owl.carousel': a.proxy (function (a) {
        a.namespace &&
          'position' == a.property.name &&
          ((this.previous = this.core.current ()), (this.next =
            a.property.value));
      }, this),
      ...
      this.core.current () !== this.previous &&
        (g &&
          ((b =
            ...
            this.core.coordinates (this.next)), d
      ...
      'initialized.owl.carousel': a.proxy (function (a) {
        a.namespace &&
          ...
          (this._core.trigger (
            ...
            null,
            'navigation'
          ), this.initialize (), this.update (), this.draw (), (this._initialized = !0), this._core.trigger (
            'initialized',
            null,
            'navigation'
          ));
      ...
      'refreshed.owl.carousel': a.proxy (function (a) {
        a.namespace &&
          ...
          (this._core.trigger (
            ...
            null,
            'navigation'
          ), this.update (), this.draw (), this._core.trigger (
            'refreshed',
            null,
            'navigation'
          ));
  ...
  (e.Defaults = {
    ...
    if (
      ('page' !== g.slideBy &&
        (g.slideBy = Math.min (g.slideBy, g.items)), g.dots ||
        'page' == g.slideBy)
    )
        ...
        : b > 0
            ...
            : b < 0 &&
                this._controls.$absolute
                  .children ()
                  .slice (b)
                  .remove (), this._controls.$absolute
        .find ('.active')
        .removeClass ('active'), this._controls.$absolute
        .children ()
    ...
    return 'page' == e.slideBy
      ? ((c = a.inArray (this.current (), this._pages)), (d = this._pages
          .length), b ? ++c : --c, (c = this._pages[(c % d + d) % d].start))
      : ((c = this._core.relative (
          this._core.current ()
        )), (d = this._core.items ().length), b
          ? (c += e.slideBy)
          : (c -= e.slideBy)), c;
  ...
  function e (b, c) {
    ...
    return a.each ((b + ' ' + h.join (f + ' ') + f).split (' '), function (
      a,
      b
    ) {
  ...
  j.csstransitions () &&
    ((a.support.transition = new String (
      f ('transition')
    )), (a.support.transition.end =
      i.transition.end[a.support.transition])), j.cssanimations () &&
    ((a.support.animation = new String (
      f ('animation')
    )), (a.support.animation.end =
      i.animation.end[a.support.animation])), j.csstransforms () &&
